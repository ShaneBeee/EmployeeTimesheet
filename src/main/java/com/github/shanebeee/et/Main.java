...
import com.github.shanebeee.et.view.OnboardingWizard;
import com.github.shanebeee.et.view.ProfilePickerDialog;
...
public class Main {
    ...
    static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            // (For single user: dataDir = EmployeeTimesheet/ = rootDir)
            // (For multi user: dataDir = EmployeeTimesheet/Username/ but rootDir = EmployeeTimesheet/)
            // Extract rootDir by truncating at EmployeeTimesheet/
            String rootDir;
            String norm = currentDataDir.replace("//", "/");
            int idx = norm.indexOf("EmployeeTimesheet" + File.separator);
            if (idx >= 0) {
                rootDir = norm.substring(0, idx + "EmployeeTimesheet".length() + 1);
            } else {
            ...
            if (profiles.isEmpty()) {
                ...
                // Create EmployeeTimesheet/Shane_Bolenback/ subfolder

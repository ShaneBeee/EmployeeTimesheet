...
public class LogEntry {
    ...
    public Map<String, Double> getBossPercentages() { return bossPercentages; }
    public void setBossPercentages(Map<String, Double> bossPercentages) { this.bossPercentages = bossPercentages; }

    public String getBossUuid() { return bossUuid; }
    public void setBossUuid(String bossUuid) { this.bossUuid = bossUuid; }
    ...
    public List<KmEntry> getKmEntries() { return kmEntries; }
    public void setKmEntries(List<KmEntry> kmEntries) { this.kmEntries = kmEntries; }

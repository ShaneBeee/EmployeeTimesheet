...
public class SettingsPanel extends JPanel {
    ...
    private JPanel buildTaxBracketsTab() {
        ...
        com.github.shanebeee.et.model.TaxBrackets[] bh = { storage.loadTaxBrackets(year) };
        ...
        Runnable build = () -> {
            cnt[0].removeAll();
            com.github.shanebeee.et.model.TaxBrackets brackets = bh[0];
    ...
    private JPanel makeBracketCard(String title, java.util.List<com.github.shanebeee.et.model.TaxBrackets.Bracket> brackets, com.github.shanebeee.et.model.TaxBrackets tb, boolean isFederal) {
        ...
        Runnable refreshRows = () -> {
            ...
            for (int i = 0; i < brackets.size(); i++) {
                final int idx = i; com.github.shanebeee.et.model.TaxBrackets.Bracket b = brackets.get(i); boolean isLast = i == brackets.size() - 1;
        ...
        btnAdd.addActionListener(e -> { double prev = brackets.size() > 1 ? brackets.get(brackets.size() - 2).getUpTo() + 10000 : 50000; brackets.add(brackets.size() - 1, new com.github.shanebeee.et.model.TaxBrackets.Bracket(prev, 0.20)); refreshRows.run(); });

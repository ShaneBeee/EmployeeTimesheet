...
public class OnboardingWizard extends JDialog {
    ...
    public OnboardingWizard(Frame owner) {
        super(owner, "Welcome to Reconciled", true);
        setSize(560, 520);
        setResizable(false);
    ...
    private JPanel buildStorageStep() {
        ...
        String iCloudPath = DataStorage.ICLOUD_BASE + "Reconciled";
        ...
        btnCustom.addActionListener(e -> {
            ...
            fd.setFile("Reconciled"); // hint
            fd.setVisible(true);
            if (fd.getDirectory() != null) {
                chosenPath = fd.getDirectory() + "Reconciled";
    ...
    private void refreshCcaList() {
        ...
        for (com.github.shanebeee.reconciled.model.CcaAsset a : onboardingCcaAssets) {

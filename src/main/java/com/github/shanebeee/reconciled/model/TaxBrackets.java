...
public class TaxBrackets {
    ...
    public List<Bracket> getFederal() {
        return federal;
    }

    public void setFederal(List<Bracket> v) {
        this.federal = v;
    }

    public List<Bracket> getBc() {
        return bc;
    }

    public void setBc(List<Bracket> v) {
        this.bc = v;
    }

    public double getCppRate() {
        return cppRate;
    }

    public void setCppRate(double v) {
        this.cppRate = v;
    }

    public double getCppMaxContribution() {
        return cppMaxContribution;
    }

    public void setCppMaxContribution(double v) {
        this.cppMaxContribution = v;
    }
